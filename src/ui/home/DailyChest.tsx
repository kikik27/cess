    ...
    <>
      ...
      <Modal show={showModal} onClose={() => setShowModal(false)}>
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 px-6 py-6 text-center">
          <span className="chest-open-anim text-6xl leading-none">🎁</span>
          <div>
      ...
      <section className="relic-frame px-4 py-4">
        ...
        <button
          ...
          className={cn(
            'flex w-full flex-col items-center gap-2 rounded-xl border py-6 transition-all',
            chestOpened
        ...
        >
          <span className={cn('select-none text-5xl leading-none', animating && 'chest-bounce')}>
            {chestOpened ? '📦' : '🎁'}
          </span>
